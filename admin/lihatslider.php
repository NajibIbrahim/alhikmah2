                          ...
                          <div class="col-lg-8">
                            <div class="p-3">
                              <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4"><b>Lihat Gambar "<?php echo $d['judul']; ?>"</h1>
                                </div>
                                ...
                                <table style="text-align: left;" border='0' class="table table-striped table-bordered table-hover">
                                  <!-- <tr class="text-lighten"> -->
                                    ...
                                    <tr>
                                      <th>Judul Gambar</th><td><?php echo $d['judul']; ?></td>
                                    </tr>
                                    <tr>
                                      <th>Gambar</th><td><img width="60%" src="img/slider/<?php echo $d['gambar'];?>"></td>
                                    </tr>
                                  </table>
                                  <hr>
                                </div>
