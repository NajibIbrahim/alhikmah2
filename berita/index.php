...
$sql = "SELECT * FROM berita join label using(id_label) order By id_berita desc";
...
<head>
	...
	<!-- Basic Page Needs
		================================================== -->
		<meta charset="utf-8">
		<title>Berita | Pondok Pesantren Al Hikmah Pedurungan Semarang</title>
...
<body>
	...
	<div class="body-inner">
		...
		<div id="banner-area" class="banner-area" style="background-image:url(../images/banner2.jpg)">
						...
						<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
							<div class="post">
								<div class="post-media post-image">
									...
									<img src="../admin/img/berita/<?= $berita['gambar']; ?>" class="img-responsive" alt="">
								...
								<div class="post-body">
									...
									<div class="entry-content">
										<p style="text-align: justify;"><?= substr($berita['isi'], 0,65); ?> ...</p>
									</div>

									<div class="post-footer">
										<a href="../lihatberita/?judul=<?= $berita['judul'];?>" class="btn btn-primary">Selengkapnya</a>
									</div>
