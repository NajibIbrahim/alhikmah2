...
<head>
  ...
  <!-- Basic Page Needs
    ================================================== -->
    <meta charset="utf-8">
    <title>Data Santri | Pondok Pesantren Al Hikmah Pedurungan Semarang</title>
            ...
            <div class="row">
              <div class="col-xs-12">
                <div class="banner-heading">
                  <h1 class="banner-title">Detail Santri</h1>
                  <ol class="breadcrumb">
                    <li><a href="../">Home</a></li>
                    <li>Cari Santri</li>
                    <li>Detail Santri</li>
      ...
      <section id="main-container" class="main-container">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6">
              <!-- tambahan -->
              <center><h2><font color=#1B99B5>Detail Santri</font></h2><center>
                <hr>  

                <table style="text-align: left;" border='0' class="table table-striped table-bordered table-hover">
                  <!-- <table style="text-align: left;" border='0' class="table table table-bordered"> -->
