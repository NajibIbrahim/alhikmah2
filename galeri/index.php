...
$sql = "SELECT * FROM galeri order By no desc";
...
<head>
	...
	<!-- Basic Page Needs
		================================================== -->
		<meta charset="utf-8">
		<title>Galeri | Pondok Pesantren Al Hikmah Pedurungan Semarang</title>
	...
	<div class="body-inner">
		...
		<section id="main-container" class="main-container">
			<div class="container">
				...
				<h3 style="text-align: center;" class="column-title">Dokumentasi Seputar Pondok Pesantren</h3>
